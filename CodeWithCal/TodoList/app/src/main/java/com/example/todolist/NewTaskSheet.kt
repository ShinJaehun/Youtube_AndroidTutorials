...
class NewTaskSheet(var taskItem: TaskItem?) : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (taskItem != null) {
            ...
            val editable = Editable.Factory.getInstance() // 이게 뭘까
            binding.name.text = editable.newEditable(taskItem!!.name) // 이게 뭘까
            binding.desc.text = editable.newEditable(taskItem!!.desc) // 이게 뭘까
