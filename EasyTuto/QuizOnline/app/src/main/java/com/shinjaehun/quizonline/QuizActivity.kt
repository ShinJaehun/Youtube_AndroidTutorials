...
import com.shinjaehun.quizonline.databinding.ActivityQuizBinding
import com.shinjaehun.quizonline.databinding.ScoreDialogBinding
    ...
    private fun startTimer() {
        ...
        object : CountDownTimer(totalTimeInMillis, 1000L) {
            override fun onTick(millisUnitilFinished: Long) {
                val seconds  = millisUnitilFinished / 1000
    ...
    override fun onClick(view: View?) {
        ...
        if (clickedBtn.id == R.id.next_btn) {
            ...
            if(selectedAnswer == questionModelList[currentQuestionIndex].correct) {
                score += 1
                Log.i(TAG, "score of quiz: ${score.toString()}")
            }
